...
$(document).ready(InitializeStripe);
...
function beginV3PaymentRequest(){
  ...
  console.log(allPaymentButtons, availablePaymentButtons, lastPaymentButton, remainingPaymentButtons);
...
function beginApplePay() {
  ...
  var totalHash = { amount: total.toFixed(2) }
